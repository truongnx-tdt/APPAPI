...
namespace StudySystem.Data.EF
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private HandleCookiesRepository _handleCookiesRepository;
        ...
        public IHandleCookiesRepository CookiesHandle
        {
            get { return _handleCookiesRepository ?? (_handleCookiesRepository = new HandleCookiesRepository(_context)); }
        }
